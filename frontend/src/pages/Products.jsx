...
export default function Products() {
  ...
  const sort = searchParams.get('sort') === 'duplicates' ? 'duplicates' : 'recent'
  ...
  }, [competitorId, operation, scalingOnly, sort, page])
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center gap-4">
        ...
        <div className="flex flex-col gap-1">
          ...
          <select
            value={sort}
            onChange={(e) => updateParam('sort', e.target.value === 'duplicates' ? 'duplicates' : '')}
            className="rounded-lg border border-[#2d3148] bg-[#161824] px-3 py-2 text-sm text-gray-100 focus:border-brand-500 focus:outline-none"
          >
            <option value="recent">Vistos recentemente</option>
            <option value="duplicates">Mais duplicados primeiro</option>
          </select>
        </div>
